...
public class ControllerServicesApi {
     ...
     * @throws ApiException if fails to make API call
     */
    public ComponentStateEntity clearState1(String id) throws ApiException {
        Object localVarPostBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException(400, "Missing the required parameter 'id' when calling clearState1");
        }
        // create path and map variables
    ...
    public ControllerServiceReferencingComponentsEntity getControllerServiceReferences(String id) throws ApiException {
        ...
        GenericType<ControllerServiceReferencingComponentsEntity> localVarReturnType = new GenericType<ControllerServiceReferencingComponentsEntity>() {};
        return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     ...
     * @throws ApiException if fails to make API call
     */
    public PropertyDescriptorEntity getPropertyDescriptor1(String id, String propertyName, Boolean sensitive) throws ApiException {
        Object localVarPostBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException(400, "Missing the required parameter 'id' when calling getPropertyDescriptor1");
        }
        // verify the required parameter 'propertyName' is set
        if (propertyName == null) {
            throw new ApiException(400, "Missing the required parameter 'propertyName' when calling getPropertyDescriptor1");
        }
        // create path and map variables
     ...
     * @throws ApiException if fails to make API call
     */
    public ControllerServiceEntity removeControllerService(String id, LongParameter version, ClientIdParameter clientId, Boolean disconnectedNodeAcknowledged) throws ApiException {
        Object localVarPostBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
     ...
     * @throws ApiException if fails to make API call
     */
    public ControllerServiceEntity updateControllerService(ControllerServiceEntity body, String id) throws ApiException {
        Object localVarPostBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
     ...
     * @throws ApiException if fails to make API call
     */
    public ControllerServiceReferencingComponentsEntity updateControllerServiceReferences(UpdateControllerServiceReferenceRequestEntity body, String id) throws ApiException {
        Object localVarPostBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
     ...
     * @throws ApiException if fails to make API call
     */
    public ControllerServiceEntity updateRunStatus1(ControllerServiceRunStatusEntity body, String id) throws ApiException {
        Object localVarPostBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when calling updateRunStatus1");
        }
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException(400, "Missing the required parameter 'id' when calling updateRunStatus1");
        }
        // create path and map variables
