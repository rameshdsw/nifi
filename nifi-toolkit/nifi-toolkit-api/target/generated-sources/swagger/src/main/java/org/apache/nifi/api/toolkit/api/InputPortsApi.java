...
public class InputPortsApi {
     ...
     * @throws ApiException if fails to make API call
     */
    public PortEntity removeInputPort(String id, LongParameter version, ClientIdParameter clientId, Boolean disconnectedNodeAcknowledged) throws ApiException {
        Object localVarPostBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
     ...
     * @throws ApiException if fails to make API call
     */
    public PortEntity updateInputPort(PortEntity body, String id) throws ApiException {
     ...
     * @throws ApiException if fails to make API call
     */
    public ProcessorEntity updateRunStatus2(PortRunStatusEntity body, String id) throws ApiException {
        Object localVarPostBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when calling updateRunStatus2");
        }
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException(400, "Missing the required parameter 'id' when calling updateRunStatus2");
        }
        // create path and map variables
